                    ...
                    <form action="{{ route('store.kegiatan') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" id="judul" placeholder="Masukkan judul ...">
                                @error('judul')
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="kegiatan" class="form-control @error('kegiatan') is-invalid @enderror" id="kegiatan" placeholder="Masukkan kegiatan ..."></textarea>
                                @error('kegiatan')
                                <div class="invalid-feedback">
                                    <strong>{{ $message}}</strong>
                                </div>
